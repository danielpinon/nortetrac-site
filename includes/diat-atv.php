...
if(strlen($tipoConteudo) > 0){
  ...
  if($totalDt > 0){
    ...
    $jsonDt['arquivosATVDt']['totalAq'] = $totalAq;
    $jsonDt['arquivosATVDt']['loopAq'] = array();
...
$arquivosATVDt = $jsonDt['arquivosATVDt'];
$totalAq = $arquivosATVDt['totalAq'];
$loopAq = $arquivosATVDt['loopAq'];

#PROCESSAR METATAGS ==
$tituloSt = 'Nortetrac ATV';
$descricaoSt = '';
$palavrasChaveSt = '';
$autorSt = '';
      ...
      <div class="container">
        ...
        <div class="section-title aos-init aos-animate" data-aos="fade-up">
          ...
          <div class="text-center">
            <button type="submit" onclick="donwloadEp()">DOWNLOAD</button>
          </div>
...
<script type="text/javascript">
  function donwloadEp(){
    ...
    var urlEp = window.location.origin;
    urlEp += '/diat-atv-download';
    urlEp += '/'+codDt;

    window.location.href = urlEp;
